...
index 0000000000000000000000000000000000000000..08fa6017ed28b2eac6e5ac262f274703091f46bf
--- /dev/null
+++ b/README.md
@@ -0,0 +1,70 @@
...
+- Settings page to control the default WhatsApp number, the booking message template (placeholders like `{package_name}`, `{hospital}`, `{procedure_type}`), and the button text.
...
+- PHP 7.4 or newer.
+- Ability to upload plugins or SFTP/SSH access.
+
+## Installation
...
+
+## Project Structure
+For the full layout and core layers (CPT, settings, shortcode, templates, assets), see `docs/healing-packages-plugin-structure.md`.
+
+## Support & Contribution
+- Open an Issue for feature requests or bugs.
+- Suggest design/accessibility improvements (RTL, colors, copy) via Pull Request.
